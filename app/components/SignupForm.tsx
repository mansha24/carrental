  ...
  return (
    <div className="mx-auto w-full max-w-xl rounded-[2rem] border border-slate-200 bg-white p-8 shadow-lg shadow-slate-900/5">
      <div className="mb-8 space-y-3">
        <p className="text-sm uppercase tracking-[0.32em] text-cyan-500">Create an account</p>
        <h1 className="text-4xl font-semibold text-slate-950">Get started in minutes</h1>
        <p className="text-slate-600">Register a new account to bookmark cars, view notifications, and manage all bookings from your dashboard.</p>
      </div>
